...
import { validateRegister, validateLogin, validateForgotPassword, validateResetPassword, } from "../middlewares/validationMiddlewares.js";
...
router.post("/forgot-password", validateForgotPassword, async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Erreur interne du serveur lors de la demande de réinitialisation",
        });
    }
});
