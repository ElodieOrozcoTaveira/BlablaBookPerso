...
// Schema de mise à jour (PUT/PATCH /rates/:id)
...
// Schema des paramètres de route (/rates/:id) - Réutilise common
export const rateParamsSchema = idParamSchema;

// Schema de recherche (?id_book=123&rating=5) avec pagination réutilisée
