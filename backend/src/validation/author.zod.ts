...
// Schema pour la route /authors/:id/avatar/:size
export const authorAvatarParamsSchema = z.object({
    id: z.string().regex(/^\d+$/, "ID doit être un nombre").transform(Number),
    size: z.enum(['thumb', 'small'], { 
...
export type AuthorAvatarParams = z.infer<typeof authorAvatarParamsSchema>;
