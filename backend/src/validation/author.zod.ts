...
// Schema de création AVEC validation birth_date/death_date
...
// Schema de mise à jour (partial du schema de base)
export const updateAuthorSchema = baseAuthorSchema.partial();

// Schema des paramètres de route (/authors/:id) - Réutilise common
