...
export const setupAssociations = () => {
    if (associationsSetup) {
        console.log('⚠️ Associations deja configurees, skip...');
        return;
    }
    ...
    // ❌ SUPPRIMe: Les associations directes sur les tables de jonction creent des boucles infinies
    // quand on utilise deja belongsToMany !
    ...
    console.log('✅ Associations Sequelize configurees avec succes !');
};

// Export de tous les modeles pour faciliter l'import
export {
    User,
    Library,
    Book,
