...
interface BookAttributes {
    ...
    imported_by?: number;            // ID de l'utilisateur qui a déclenché l'import
    imported_at?: Date;
    imported_reason?: 'rate' | 'review' | 'library' | 'search';
...
class Book extends Model<BookAttributes, BookCreationAttributes> implements BookAttributes {
    ...
    public imported_reason?: 'rate' | 'review' | 'library' | 'search';
...
Book.init(
{
    ...
    imported_reason: {
        type: DataTypes.ENUM('rate', 'review', 'library', 'search'),
        allowNull: true,
    },
