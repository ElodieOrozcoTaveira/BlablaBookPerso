...
// Selectionne la partie de la requete a valider
            let dataToValidate;
            switch (type) {
...
// Pour les query params, j' evite de reassigner req.query (peut etre readonly)
            switch (type) {
                case ValidationType.BODY:
                ...
                case ValidationType.PARAMS:
                    ...
                    break;
                case ValidationType.QUERY:
// stocke la query validee dans res.locals pour passage propre aux handlers
