...
async function getUserPermissions(userId: number): Promise<string[]> {
    try {
        // Je recupere les permissions de l'utilisateur seulement en mode developpement
        if (process.env.NODE_ENV !== 'production') {
    ...
    const user = await UserModel.findByPk(userId);
        ...
        // J'utilise les methodes magiques Sequelize pour recuperer les roles
        ...
        // Je recupere toutes les permissions de tous les roles
