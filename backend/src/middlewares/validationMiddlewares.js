...
export const registerSchema = z.object({
    ...
    password: z
        ...
        .regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]/, "Le mot de passe doit contenir au moins: 1 minuscule, 1 majuscule, 1 chiffre, 1 caractère spécial"),
    firstname: z
        .string()
 ...
 */
export const validateRegisterPartial = createValidationMiddleware(registerSchema.partial());
/**
 ...
 */ 
//# sourceMappingURL=validationMiddlewares.js.map