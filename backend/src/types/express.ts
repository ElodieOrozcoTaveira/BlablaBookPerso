...
// Extension pour les requetes authentifiees
...
> = TypedRequest<Body, Params, Query> & {
    ...
    userPermissions?: string[]; // Permissions récupérées par le middleware RBAC
};

// Extension pour les requetes authentifiees avec upload Multer
export type AuthenticatedMulterRequest<
    Body = any,
    Params extends Record<string, any> = Record<string, any>,
    Query = any
> = AuthenticatedRequest<Body, Params, Query> & {
