...
export class ReadingListController {
  ...
  static async createReadingList(req: Request, res: Response): Promise<void> {
    try {
      const listData: CreateReadingListData = req.body;
   ...
   */
  static async getAllReadingLists(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (req.query.libraryId) {
        filters.libraryId = parseInt(req.query.libraryId as string);
      }
   ...
   */
  static async getReadingListById(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async getUserReadingLists(req: Request, res: Response): Promise<void> {
    try {
      ...
      const readingLists = await ReadingListService.getUserReadingLists(
        userId,
        includeInactive
      );
  ...
  static async updateReadingList(req: Request, res: Response): Promise<void> {
    try {
      const listId = parseInt(req.params.id as string);
      const updateData: UpdateReadingListData = req.body;
   ...
   */
  static async deleteReadingList(req: Request, res: Response): Promise<void> {
    try {
      const listId = parseInt(req.params.id as string);
   ...
   */
  static async searchReadingLists(req: Request, res: Response): Promise<void> {
    try {
      ...
      const readingLists = await ReadingListService.searchReadingLists(
        searchTerm,
        userId,
        limit
      );
   ...
   */
  static async getReadingListStats(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async toggleReadingListStatus(
    ...
    try {
      ...
      const updatedList = await ReadingListService.toggleReadingListStatus(
        listId
      );
   ...
   */
  static async checkReadingListExists(
    req: Request,
    res: Response
  ): Promise<void> {
    try {
