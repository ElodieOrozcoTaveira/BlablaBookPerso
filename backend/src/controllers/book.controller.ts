...
export const getBookCoverInfo = async (
    req: TypedRequest<any, BookParams>,
    res: Response,
    next: NextFunction
): Promise<void> => {
    try {
        ...
        if (!coverUrl) {
            res.json({
                ...
                data: {
                    hasImages: false,
                    formats: [],
                    message: 'Aucune couverture disponible'
                }
            });
            return;
        }
        ...
        try {
            // Parse du JSON des URLs d'images
            ...
            res.json({
                ...
                data: {
                    ...
                    formats: ['webp'],
                    sizes: {
                        thumb: imageUrls.thumb || null,
                        small: imageUrls.small || null, 
                        medium: imageUrls.medium || null
                    },
                    aspectRatio: '5:8',
                    optimized: true
                }
