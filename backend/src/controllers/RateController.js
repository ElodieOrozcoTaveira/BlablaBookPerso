...
export class RateController {
    ...
    static async getAllRates(req, res) {
        try {
            ...
            if (req.query.readingListId) {
                filters.readingListId = parseInt(req.query.readingListId);
            }
     ...
     */
    static async getUserRateForBook(req, res) {
        try {
     ...
     */
    static async getBookAverageRate(req, res) {
        try {
            const bookId = parseInt(req.params.bookId);
            if (isNaN(bookId)) {
                res.status(400).json({
     ...
     * GET /api/rates/stats
     */
    static async getRateStats(req, res) {
        try {
     ...
     */
    static async getRecentRates(req, res) {
        try {
     ...
     */
    static async checkRateExists(req, res) {
        try {
            const rateId = parseInt(req.params.id);
            if (isNaN(rateId)) {
                res.status(400).json({
