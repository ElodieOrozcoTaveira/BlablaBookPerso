// Contrôleur d'export pour démontrer l'usage des permissions EXPORT
...
/**
 * Export des données utilisateur (RGPD - droit à la portabilité)
 */
        ...
        if (format === 'csv') {
            ...
            return res.json({
                ...
                data: {
                    ...
                    // Simplification: les entrées de liste de lecture peuvent être reconstruites via libraries + books (pivot ReadingList)
                    reading_lists: []
                }
            });
        }
...
/**
 * Export admin - Statistiques du système
 */
...
/**
 * Export des bibliothèques utilisateur en CSV
 */
...
/**
 * Export des données utilisateur en XML
 */
