...
async function testAuthArchitecture() {
    ...
    try {
        ...
        const isInvalid = await PasswordService.verifyPassword("MauvaisMotDePasse", hashedPassword);
        ...
        console.log("   ✅ AuthService: Disponible (avec méthodes registerUser, authenticateUser, getUserById)");
