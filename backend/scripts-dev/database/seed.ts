...
async function seedDatabase() {
    ...
    console.log('✅ Schema sync complete');
        ...
        const permissionData = [
            ...
            { label: 'UPDATE_LIBRARY', action: 'Modifier ses propres bibliotheques' },
            { label: 'DELETE_LIBRARY', action: 'Supprimer ses propres bibliotheques' },
            { label: 'UPDATE_NOTICE', action: 'Modifier ses propres avis' },
            { label: 'DELETE_NOTICE', action: 'Supprimer ses propres avis' },
            { label: 'UPDATE_RATE', action: 'Modifier ses propres evaluations' },
            { label: 'DELETE_RATE', action: 'Supprimer ses propres evaluations' },
            { label: 'UPDATE_READING_LIST', action: 'Modifier ses propres listes de lecture' },
            { label: 'DELETE_READING_LIST', action: 'Supprimer ses propres listes de lecture' },
    ...
    // User: permissions generiques minimales + ownership 
    const userAllowed = ['CREATE', 'READ', 'UPDATE', 'DELETE_READING_LIST', 'UPDATE_READING_LIST', 'DELETE_LIBRARY', 'UPDATE_LIBRARY', 'DELETE_NOTICE', 'UPDATE_NOTICE', 'DELETE_RATE', 'UPDATE_RATE'];
