...
describe('Notice Controller - lazy import', () => {
    ...
    it('imports and confirms a book then creates a review', async () => {
        req.body = {
            open_library_key: '/works/OL999W',
            content: 'Un avis sur le livre',
            is_public: true,
            is_spoiler: false
        };
        ...
        // New standardized actionType 'add_review' (formerly 'notice_book')
