...
describe('Book Controller', () => {
    ...
    describe('createBook', () => {
        it('should create a new book with relationships', async () => {
            // Créer des auteurs et genres de test
    ...
    describe('getAllBooks', () => {
        beforeEach(async () => {
            ...
            // Associer les relations (les relations many-to-many nécessitent une approche différente)
            // Pour l'instant, on teste seulement la création du livre
