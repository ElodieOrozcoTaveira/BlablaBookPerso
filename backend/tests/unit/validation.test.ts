...
describe('Validation Zod Schemas', () => {
  ...
  describe('Common Schemas', () => {
    ...
    test('paginationSchema - should reject limit over 100', () => {
      expect(() => paginationSchema.parse({ limit: '101' })).toThrow('Maximum 100 éléments par page');
    });
  ...
  // Tests de cohérence entre schémas
