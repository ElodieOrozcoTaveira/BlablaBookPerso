...
// Utiliser vi.hoisted pour garantir disponibilité lors du hoisting des factories
...
describe('NoticeService lazy import (open_library_key)', () => {
  ...
  it('importe temporairement puis confirme (update appelé) quand import_status=temporary', async () => {
  ...
  it('ne rappelle pas update si déjà confirmé', async () => {
  ...
  it('propage erreur OPENLIB_IMPORT_FAILED si prepare échoue', async () => {
