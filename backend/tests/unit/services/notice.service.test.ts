...
vi.mock('../../../src/models/Notice.js', () => ({ default: { create: vi.fn(), findAndCountAll: vi.fn() } }));
vi.mock('../../../src/models/Book.js', () => ({ default: { findByPk: vi.fn() } }));
vi.mock('../../../src/services/book-action.service.js', () => ({
  BookActionService: class { prepareBookForAction = vi.fn().mockResolvedValue({ book: { id_book: 77, import_status: 'temporary', update: vi.fn() } }); }
}));
...
describe('NoticeService', () => {
  ...
  // NOTE: Confirmation import_status test retire car instance BookActionService differente de Book.findByPk mock
