...
import {
    ...
    updateGenre,
    deleteGenre
} from '../../../src/controllers/genre.controller.js';

jest.mock('../../../src/controllers/genre.controller');

const mockCreateGenre = createGenre as jest.Mock;
const mockGetAllGenres = getAllGenres as jest.Mock;
const mockGetGenreById = getGenreById as jest.Mock;
const mockUpdateGenre = updateGenre as jest.Mock;
const mockDeleteGenre = deleteGenre as jest.Mock;
...
describe('Genre Routes', () => {
    ...
    beforeEach(() => {
        ...
        const genreRoutes = require('../../../src/routes/genres').default;
