...
import { useMyBooksStore } from "@/store/addBook"; //utilisation du store zustand pour récupérer les livres
    ...
    return(
        ...
        <div className="mesLivres-grid">
            ...
            {myBooks.length === 0 ? (
                ...
                {myBooks.map((book) => (
                    <article className="mesLivres-list" key={book.id || book.isbn}>
                    <div>
