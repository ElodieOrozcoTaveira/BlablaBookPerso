...
const SearchBar: React.FC<SearchBarProps> = ({ onSelect }) => {//Searchbar est un composant qui prend éventuellement une prop onSelect
  ...
  const handleBookSelect = (book: Book) => {
    setSearchQuery(book.title);// Met à jour l’input avec le titre du livre sélectionné
    setShowResults(false); // Cache la liste des résultats
    if (onSelect) onSelect(book); {/* Si la prop onSelect existe, appelle cette fonction avec le livre sélectionné
}; */}
  };
